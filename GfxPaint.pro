...
win32:DEFINES += APP_VERSION=$$QT_REQUIRED_MAJOR_VERSION.$$QT_REQUIRED_MINOR_VERSION
else:DEFINES += APP_VERSION=$$QT_REQUIRED_MAJOR_VERSION.$$QT_REQUIRED_MINOR_VERSION.$$QT_REQUIRED_PATCH_VERSION
